...
public class Kaydol extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "İlkokul Öğretmeninin Adı?", "En Sevdiğin Yemek?", "En Sevdiğiniz Spor?", "Komşunuzun Evcil Hayvanının İsmi?", "En İyi Çocukluk Arkadaşınızın Adı?" }));
