...
public class TeslimEtme extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(451, 11, -1, -1));
        ...
        btnTeslimAl.setBackground(new java.awt.Color(0, 204, 255));
        btnTeslimAl.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        btnTeslimAl.setForeground(new java.awt.Color(255, 255, 255));
...
private double ArabaUcretiBul(int gelenId){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeslimEtme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
